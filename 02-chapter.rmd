...
When you add a chapter, go to the `***` and add it to the list of files to be included in the book, in the order you'd like them.

This lets you rearrange the book easily.
